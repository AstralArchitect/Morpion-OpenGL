...
int main()
{
    ...
    horloge = GltfModel("./res/models/horloge.glb", shader_store);
    horloge.set_global_uniforms(glm::translate(glm::scale(glm::mat4(1.0f), glm::vec3(.5f)), glm::vec3(.0, -2., 0.0)));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, shadow_info.depthMapFBO);
            ...
            glCullFace(GL_FRONT);
            Render::renderScene(window, renderList, lightSpaceMatrix);
            glCullFace(GL_BACK);
